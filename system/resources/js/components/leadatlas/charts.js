...
/**
 * Charts — every chart on the user dashboard.
 *
 * The backend fills ONE element and this draws it:
 *
 ...
 *
 * Colours are read from the @theme tokens at runtime rather than hardcoded,
 * so a palette change reaches the charts too. Optional data-chart-color picks
 * the role: discover (map data), ai (machine output), accent (commercial),
 * success. Defaults to discover.
 */
