...
<header class="relative isolate overflow-hidden border-b border-neutral-200 bg-[#f6f5ff] pt-[calc(72px+2.5rem)] pb-10 md:pt-[calc(72px+3.5rem)] md:pb-12" data-anim>
    ...
    <div class="container">
        ...
        <div class="max-w-[38rem]" data-anim-item>
            ...
            @if(!empty($data['lead']))
                <p class="mt-4 text-[1rem] leading-[1.6] md:text-[1.0625rem]">{{ $data['lead'] }}</p>
            @endif
        </div>
    </div>
</header>
