<x-layouts.user :title="__('New search')">
    <form class="srch-page" action="{{ route('user.search.new') }}" method="get"
          data-estimate-form data-balance="2480">
        <div class="srch">
            <aside class="srch__rail" aria-label="{{ __('Search filters') }}">
                ...
                <div class="fac" data-accordion>
                    ...
                    <div class="fac__panel" id="f-type" data-accordion-panel>
                        <div class="ffield is-filled" data-filter-field data-filter-name="keyword[]">
                            <span data-filter-chips class="contents">
                                <span class="ffield__chip" data-value="dentists">
                                    <span>{{ __('dentists') }}</span>
                                    <input type="hidden" name="keyword[]" value="dentists" />
                                    <button type="button" class="ffield__x" aria-label="{{ __('Remove dentists') }}">
                                        <i class="ph ph-x" aria-hidden="true"></i>
                                    </button>
                                </span>
                            </span>
                ...
                <div class="fac" data-accordion>
                    ...
                    <div class="fac__panel" id="f-location" data-accordion-panel>
                        <div class="ffield is-filled" data-filter-field data-filter-name="location[]">
                            <span data-filter-chips class="contents">
                                <span class="ffield__chip" data-value="Austin, TX">
                                    <span>{{ __('Austin, TX') }}</span>
                                    <input type="hidden" name="location[]" value="Austin, TX" />
                                    <button type="button" class="ffield__x" aria-label="{{ __('Remove Austin, TX') }}">
                                        <i class="ph ph-x" aria-hidden="true"></i>
                                    </button>
                                </span>
                            </span>
                    ...
                    <div class="panel mt-0" data-list data-bulk>
                        ...
                        <div class="table-scroll">
                            <table class="d-table d-table--cards whitespace-nowrap" data-list-table>
                                ...
                                <tbody>
                                    <tr data-list-key="found" data-score="hi" data-contact="yes">
                                        ...
                                        <td data-label="Phone">
                                            <a href="tel:+15125550143" class="d-table__tel numeric">(512) 555-0143</a>
                                        </td>
                                    ...
                                    <tr data-list-key="found" data-score="hi" data-contact="yes">
                                        ...
                                        <td data-label="Contact">
                                            <a href="#" class="d-table__mail">front.desk@lamarfamily.com</a>
                                        </td>
                                        <td data-label="Phone">
                                            <a href="tel:+15125550198" class="d-table__tel numeric">(512) 555-0198</a>
                                        </td>
                                        <td data-label="Score" class="text-right">
                                    ...
                                    <tr data-list-key="found" data-score="hi" data-contact="yes">
                                        ...
                                        <td data-label="Phone">
                                            <a href="tel:+15125550246" class="d-table__tel numeric">(512) 555-0246</a>
                                        </td>
                                        <td data-label="Score" class="text-right">
                                    ...
                                    <tr data-list-key="found" data-score="mid" data-contact="yes">
                                        <td class="d-table__check">
                                        ...
                                        <td data-label="Contact">
                                            <a href="#" class="d-table__mail">contact@zilkersmile.com</a>
                                        </td>
                                        <td data-label="Phone">
                                            <a href="tel:+15125550311" class="d-table__tel numeric">(512) 555-0311</a>
                                        </td>
                                        <td data-label="Score" class="text-right">
                                    ...
                                    <tr data-list-key="found" data-score="lo" data-contact="no">
                                        <td class="d-table__check">
                                            <input type="checkbox" class="form-check" data-bulk-item aria-label="{{ __('Select Sunset Valley Dental') }}" />
                                        </td>
                                        <td data-card-title>
                                            <a href="#" class="d-table__id">{{ __('Sunset Valley Dental') }}</a>
                                            <p class="d-table__place">
                                                <i class="ph ph-map-pin" aria-hidden="true"></i>
                                                {{ __('Austin, TX') }}
                                            </p>
